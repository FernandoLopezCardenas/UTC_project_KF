...
X_m = [ber_mea_x'; ber_mea_y'; ber_mea_theta'];
%%Measured poses with noise
X_m = [ber_mea_x'; ber_mea_y'; ber_mea_theta'] %+ ruido_uniforme';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% DATA LOSS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% n_ran = randi([1,20]);
% for m = 1 : n_ran
...
%Measurement
plot(X_m(1,:),X_m(2,:),'--g','LineWidth',1.5)
%Ground truth
...
%Measurement
plot(linspace(ti,tf,length(Xk)-1),X_m(1,:),'--g','LineWidth',1.5)
% %Ground truth
